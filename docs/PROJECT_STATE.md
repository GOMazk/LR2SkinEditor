...
탐색 UI, 정적 Preview 복원을 포함한다. ID 없는 Object의 분리 후 선택 복원과
애니메이션 중 Preview 파일 소유권 판정도 수정했다. 저장 포맷은 OLRskin 0.9를
유지한다. 브랜치 소유권과 검증 결과는 [이식 기록](AI_2_IMPORT_2026-09-12.md)을 따른다.
