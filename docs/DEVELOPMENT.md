...
- [현재 개발 상태와 설계](PROJECT_STATE.md)
- [빌드, 실행 및 회귀 테스트](BUILD_AND_TEST.md)
- [UI 구조와 디버깅 규칙](UI_ARCHITECTURE.md)
- [OLRskin 0.9 고정 포맷](OLRSKIN_FORMAT.md)
- [외부 코드 고지](THIRD_PARTY_NOTICES.md)
- [AI/UI 지도 생성 및 활용](UI_MAP.md)
- [AI 협업 시작 가이드](AI_COLLABORATION.md)
- [변경 인계 템플릿](HANDOFF_TEMPLATE.md)
...
검증 절차는 [빌드 문서](BUILD_AND_TEST.md)를 따르십시오.
