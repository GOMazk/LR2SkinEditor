...
struct MV1_MATERIAL_R
{
	...
	int						EmissiveTexNum ;				// 自己発光テクスチャの数
	MV1_TEXTURE_R			*EmissiveTexs[ 256 ] ;			// 自己発光テクスチャへのポインタの配列
	int						ShininessTexNum ;				// ラフネスマップテクスチャの数
	MV1_TEXTURE_R			*ShininessTexs[ 256 ] ;			// ラフネスマップテクスチャへのポインタの配列
	int						ReflectionFactorTexNum ;		// メタリックマップテクスチャの数
	MV1_TEXTURE_R			*ReflectionFactorTexs[ 256 ] ;	// メタリックマップテクスチャへのポインタの配列
