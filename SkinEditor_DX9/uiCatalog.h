...
inline constexpr SEUIWindowSpec kSEUIWindowSpecs[] = {
    ...
    { SEUIWindowId::AssetBrowser, "asset-browser", "Asset Browser", "Compact crop grid with Add/Options menus; search, preview, apply and drag assets without changing dock geometry.", "WORKSPACE::drawAssetBrowser", "Assets", "center-bottom", true },
    ...
    { SEUIWindowId::ObjectInspector, "object-inspector", "Object Inspector", "Edit shared Object properties using wrapping section navigation and width-aware fields; hover (?) for Preview visibility diagnostics.", "WORKSPACE::drawObjectInspector", "Workspace", "left-inspector", true },
...
inline constexpr SEUISurfaceSpec kSEUISurfaceSpecs[] = {
    ...
    { SEUISurfaceId::DstAsset, "dst-asset", "Images from layout", "Choose Objects and create shared or separate PNGs with paint-over borders by default, or transparent PNGs with separate guides; reload external PNG edits automatically.", "WORKSPACE::drawDstAssetDialog", "dialog" },
